  ...
  <div class="w-192 mx-auto">
    ...
    <div class="mt-8">
      ...
      <form method="post" action="{{ route('contact') }}">
        @csrf
        <div class="mb-4">
      <?php // value="{{old('name属性')} を設定すればエラーの自動リダイレクト後にフラッシュメッセージで入力内容を持ち越せる ?>
          ...
          @if($errors->has('name'))
          <p class="text-red-400 mt-1">{{ $errors->first('name') }}</p>
          @endif
        </div>
        <div class="mb-4">
          ...
          <p class="text-red-400 mt-1">{{ $errors->first('name_kana') }}</p>
          @endif
        </div>
        <div class="mb-4">
          ...
          @if($errors->has('phone'))
          <p class="text-red-400 mt-1">{{ $errors->first('phone') }}</p>
          @endif
        </div>
        <div class="mb-4">
          ...
          @if($errors->has('email'))
          <p class="text-red-400 mt-1">{{ $errors->first('email') }}</p>
          @endif
        </div>
        <div class="mb-4">
          ...
          <?php //textareaにvalue属性は設定できないため、タグの中に出力する ?>
          ...
          @if($errors->has('body'))
          <p class="text-red-400 mt-1">{{ $errors->first('body') }}</p>
          @endif
        </div>
